...
<section class="background_bg breadcrumb_section  page-title-light"  style ="height:450px;"data-img-src="<?php echo base_url()?>assets/frontend/linibisnis/<?php echo "$gambar_sub"; ?>">
    <div class="container">
        <div class="row">
