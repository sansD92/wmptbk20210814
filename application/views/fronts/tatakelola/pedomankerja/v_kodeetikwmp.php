        ...
        <div class="row align-items-center">
            <div class="col-md-12 col-sm-12 mb-12 mb-lg-0 ">
                <div class="col-md-12 col-sm-12 mb-12 mb-lg-0 ">
                    ...
                    <h2>Kode etik PT Widodo Makmur Perkasa, Tbk</h2>
                </div>
                <div class="col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                <center><div class="heading_s3">
                    <h4>                        
                      <a style="color: #BD2132;"href="<?php echo base_url()?>assets/frontend/pdf/pedoman-kerja/Kode Etik WMP.pdf" target="_blank" type="application/pdf">Kode etik PT Widodo Makmur Perkasa, Tbk</a></h4>
                </div></center>
