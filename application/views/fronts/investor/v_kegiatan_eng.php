    	...
    	<div class="row">
        	<div class="col-md-12 text-center">
            	<div class="page-title">
            		<h1>Kegiatan Update Dan Presentasi Perusahaan</h1>
                </div>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                    <li class="breadcrumb-item"><a href="#">Tentang Kami</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Kegiatan Update Dan Presentasi Perusahaan</li>
                  </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 col-sm-12 animation" data-animation="fadeInRight" data-animation-delay="0.4s">
                <div class="heading_s3 mb-3"> 
                  <h3>Kegiatan Update Dan Presentasi Perusahaan</h3>
                </div>
