                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="bisnis_kategori_judul" placeholder="">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Judul ENG</label>
                        <input type="text" class="form-control" name="bisnis_kategori_judul_eng" placeholder="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
