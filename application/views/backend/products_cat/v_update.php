      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo base_url()?>aspanel/products_cat">Category Products</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card card-primary">
            ...
            echo form_open_multipart('aspanel/products_cat_update',$attributes); ?>
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-primary" title="Batal" href="<?php echo base_url()?>aspanel/products_cat"><i class="fab fa-creative-commons-sa"></i> Cancel</a>
