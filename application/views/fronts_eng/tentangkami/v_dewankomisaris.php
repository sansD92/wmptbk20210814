                        ...
                        <div class="team_img">
                            ...
                            <ul class="list_none social_icons border_social">
                               <li>
                                    ...
                                    <button type="button" class="btn btn-outline-white" data-toggle="modal" data-target="#modal-<?php echo $post_new->id_komisaris ?>">More Detail</button>
                            </ul>
                        </div>
                        <div style="max-height: 80px;"class="team_title">
                          <br>
                            <h5><?php echo $post_new->nama_komisaris ?></h5>
                            <span><?php echo $post_new->jabatan_komisaris_eng  ?></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="heading">
                                    ...
                                    <p class="member-title"><?php echo $post_new->jabatan_komisaris_eng ?></p>
                                    <p class="text-dark text-justify"><?php echo $post_new->deskripsi_jabatan_eng ?></p>
                                  </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="team_img">
                            ...
                            <ul class="list_none social_icons border_social">
                               <li>
                                    <h6 style="color: #fff"></h6></li>
                                    <!-- <a href="#" class="btn btn-outline-white">Lebih Detail</a> -->
                                    <button type="button" class="btn btn-outline-white" data-toggle="modal" data-target="#modals-<?php echo $post_new->id_direksi ?>">More Detail</button>
                            </ul>
                        </div>
                        <div class="team_title">
                          <br>
                            <h5><?php echo $post_new->nama_direksi ?></h5>
                            <span><?php echo $post_new->jabatan_direksi_eng  ?></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="heading">
                                    ...
                                    <p class="member-title"><?php echo $post_new->jabatan_direksi_eng  ?></p>
                                    <p class="text-dark text-justify"><?php echo $post_new->deskripsi_jabatan_eng  ?></p>
                                  </div>
                            </div>
                        </div>
